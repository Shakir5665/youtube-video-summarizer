...
def generate_summary(text, max_retries=3):
    """
    Generate summary using Gemini AI with retry logic and error handling
    """
...
Please try a different video with more spoken content.
    ...
    if len(text) > 25000:
        text = text[:25000]
        print(f"⚠️ Transcript trimmed to 25000 characters")
            ...
            try:
                ...
                if "503" in error_msg or "UNAVAILABLE" in error_msg:
                    if attempt < max_retries - 1:
                        ...
                        print(f"⚠️ {model_name} busy, retrying in {wait_time:.1f} seconds...")
